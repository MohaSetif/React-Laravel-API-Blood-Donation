        ...
        <table className="min-w-full table-auto text-left text-sm font-light">
          <tbody>
            <tr
              ...
              <td className="whitespace-nowrap px-6 py-4">National ID</td>
              <td className="whitespace-nowrap px-6 py-4 font-medium">{ inputs.id }</td>
            </tr>
            <tr
              className="border-b bg-white dark:border-neutral-500 dark:bg-neutral-600">
            ...
            <tr
              className="border-b bg-white dark:border-neutral-500 dark:bg-neutral-600">
              <td className="whitespace-nowrap px-6 py-4">Health status</td>
              <td className="whitespace-nowrap px-6 py-4 font-medium">{ inputs.status }</td>
            </tr>
          </tbody>
        </table>
      </div>
