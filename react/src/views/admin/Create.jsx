...
<h1 className="font-bold text-center text-2xl">Add new user</h1>
<form className="w-full max-w-lg mx-auto mt-10" method="POST" onSubmit={submitForm}>
  ...
  <div className="w-full md:w-1/3 px-3">
    ...
    <div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">
      ...
      <div className="relative">
        <select onChange={handleChange} className="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state" name="usertype" value={inputs.usertype || ''}>
          <option>Choose:</option>
          <option>donor</option>
  ...
  <div className="flex flex-wrap -mx-20 mb-6">
    <div className="w-full md:w-1/2 px-3">
      ...
      <input value={inputs.email || ''} onChange={handleChange} className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="email" type="email" name="email"/>
    </div>
    ...
    <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
      ...
      <input value={inputs.password || ''} onChange={handleChange} className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password" type="password" name="password"/>
    </div>
  </div>
